...
$config['database']['custom']['user_profile']['custom_columns'] = array(
    'user_firstname', 'user_lastname', 'user_phone', 'upro_newsletter', 'bgroup_id_fk', 'user_profile_pic'
);
 ...
 */
$config['security']['recaptcha_theme'] = 'red';
...
$config['email']['site_title'] = "PRD Logistics";
