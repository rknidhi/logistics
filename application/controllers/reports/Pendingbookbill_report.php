...
class Pendingbookbill_report extends CI_Controller {
    ...
    function index() {
        if (!$this->flexi_auth->is_privileged('Pending Bill Report')) {
        ...
        $this->load->view('reports/pendingbookbill_report', $this->data);
    }
