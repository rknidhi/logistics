...
class Brokerage_report extends CI_Controller {
    ...
    function index() {
        if (!$this->flexi_auth->is_privileged('Brokerage Report')) {
        ...
        if (!empty($this->input->post('submit'))) {
            ...
            $this->db->where('challan_dispatch.broker_id_fk !=', 0);
            $this->db->join('booking_gr', "challan_dispatch.gr_no_fk = booking_gr.bgr_id", "INNER");
        ...
        $this->load->view('reports/brokerage_report', $this->data);
    }
