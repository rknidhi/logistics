...
class Loading_report extends CI_Controller {
    ...
    function index() {
        if (!$this->flexi_auth->is_privileged('Loading Report')) {
        ...
        $this->load->view('reports/loading_report', $this->data);
    }
