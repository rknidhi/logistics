...
class Item extends CI_Controller {
    ...
    function index() {
        ...
        $this->data['items'] = $this->functions->get_all_row('tbl_master_item');
        $this->load->view('master/item/view', $this->data);
    }
    ...
    function add_item() {
        ...
        $this->load->view('master/item/add', $this->data);
    }
    ...
    function add_item_ajax() {
        ...
        $this->data['bagents'] = $this->functions->get_all_active_row('tbl_master_branch_agent');
        $this->data['companies'] = $this->functions->get_all_active_row('tbl_master_company');
        $this->load->view('master/item/add_ajax', $this->data);
    }
    ...
    function edit_item($item_id) {
        ...
        $this->data['bagents'] = $this->functions->get_all_active_row('tbl_master_branch_agent');
        $this->data['companies'] = $this->functions->get_all_active_row('tbl_master_company');
        $this->data['item'] = $this->functions->get_single_row('tbl_master_item', 'item_id', $item_id);
        $this->load->view('master/item/edit', $this->data);
    }

    function detail_item($item_id) {
        $this->data['item'] = $this->functions->get_single_row('tbl_master_item', 'item_id', $item_id);
        $this->load->view('master/item/details', $this->data);
    }

    function delete() {
        $item_id = $this->input->post('id');
        $response = $this->functions->delete_single_row('tbl_master_item', 'item_id', $item_id);
        //FOR ACTIVIES LOG
    ...
    function add() {
        ...
        $response = $this->functions->insert_into_table('tbl_master_item', $data);
        //FOR ACTIVIES LOG
        $activites['user_id'] = $this->flexi_auth->get_user_id();
    ...
    function update($item_id) {
        $data = $this->input->post('data');
        $data['modified_by'] = $this->flexi_auth->get_user_id();
        $response = $this->functions->update_table_rows('tbl_master_item', 'item_id', $item_id, $data);
        //FOR ACTIVIES LOG
        $activites['user_id'] = $this->flexi_auth->get_user_id();
        $activites['activity_id'] = $item_id;
        $activites['activity_type'] = 'Item';
