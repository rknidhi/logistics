...
class Auth_public extends CI_Controller {
    ...
    function update_account() {
        ...
        if ($this->input->post('update_account')) {
            ...
            //Upload Image
            $uacc_id_fk = $this->flexi_auth->get_user_id();
            if (!empty($_FILES['image_em']['name'])) {
                ...
                $this->functions->update_table_rows('user_profiles', 'upro_uacc_fk', $uacc_id_fk, $user_data);
            }
        ...
        $this->load->view('public/account_update_view', $this->data);
    }
    ...
    function change_password() {
        ...
        $this->load->view('public/password_update_view', $this->data);
    }
