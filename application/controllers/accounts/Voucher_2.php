        ...
        foreach($ref_no['lhcno'] as $key => $value){
         $gr_index++;   
            if($value != ''){
                ...
                foreach($ref_no['grnos'][$gr_index] as $key1 => $value1){
                        if($value != ''){
                            $gr_valdata['amount'] = $ref_no['amount'][$key];
                            $gr_valdata['reference_no'] = $value;
                            $gr_valdata['billtype'] = 'Challan';
                            $gr_valdata1[] = json_encode($gr_valdata);
                          }
                    }  
