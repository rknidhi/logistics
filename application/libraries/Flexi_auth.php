...
class Flexi_auth extends Flexi_auth_lite {
    ...
    public function change_password_by_admin($user_id, $identity, $new_password) {
        if ($this->CI->flexi_auth_model->change_password_by_admin($user_id, $identity, $new_password)) {
            $this->CI->flexi_auth_model->set_status_message('password_change_successful', 'config');
            return TRUE;
        }
