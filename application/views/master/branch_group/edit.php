<div class="row">
    <div class="card card-outline-primary">
        <div class="card-header">
            <h4 class="m-b-0 text-white">Update Branch Group</h4>
        </div>
        <div class="card-body myModal">
            <form class="m-t-10 row" id="form_validation" novalidate action="<?= $base_url ?>master/branch_group/update/<?= $branchgroup->bgroup_id ?>" method="POST">
                <div class="form-group col-md-12 m-t-10">
                    <h5>Freight Method <span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[branch_group]" value="<?= $branchgroup->branch_group ?>" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
