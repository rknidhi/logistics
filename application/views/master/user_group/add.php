<div class="row">
    <div class="card card-outline-primary">
        <div class="card-header">
            <h4 class="m-b-0 text-white">Add User Group</h4>
        </div>
        <div class="card-body myModal">
            <form class="m-t-10 row" id="form_validation" novalidate action="<?= $base_url ?>master/user_group/add" method="POST">
                <div class="form-group col-md-6 m-t-10">
                    <h5>Group Name <span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[ugrp_name]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
                <div class="form-group col-md-6 m-t-10">
                    <h5>Description</h5>
                    <div class="controls">
                        <input type="text" name="data[ugrp_desc]" class="form-control"></div>
                </div>
