    ...
    <div class="card card-outline-primary">
        ...
        <form class="m-t-10 row" id="form_validation2" novalidate action="<?= $base_url ?>master/party/add_ajax" method="POST">
                <div class="form-group col-md-3">
                    ...
                    <div class="controls">
                        <input type="text" name="data[party_name]" id="party_name" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (response.status == 'success') {
                        ...
                        } else if (user_type == 'thirdparty') {
                            $('#thirdparty_id_fk').append(newOption);
                            $('#thirdparty_id_fk').val(response.status_message).change();
                        } else {
