<div class="row">
    <div class="card card-outline-primary">
        ...
        <div class="card-body myModal">
            <form class="m-t-10 row" id="form_validation" novalidate action="<?= $base_url ?>master/vendor/add" method="POST">
                <div class="form-group col-md-3 m-t-10">
                    <h5>Name<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[vendor_name]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>

                <div class="form-group col-md-3 m-t-10">
                    <h5>Address<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[vendor_address]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>

                <div class="form-group col-md-3 m-t-10">
                    <h5>City<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[vendor_city]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
                ...
                <div class="form-group col-md-3 m-t-10">
                    <h5>GSTIN</h5>
                    <div class="controls">
                        <input type="text" name="data[vendor_gstin]" class="form-control"></div>
                </div>

                <div class="form-group col-md-3 m-t-10">
                    <h5>Pincode</h5>
                    <div class="controls">
                        <input type="text" name="data[pincode]" class="form-control"></div>
                </div>

                <div class="form-group col-md-3 m-t-10">
                    <h5>Phone</h5>
                    <div class="controls">
                        <input type="text" name="data[vendor_phone]" class="form-control"></div>
                </div>

                <div class="form-group col-md-3 m-t-10">
                    <h5>Email ID</h5>
                    <div class="controls">
                        <input type="email" name="data[email_id]" class="form-control"></div>
                </div>
                <div class="form-group col-md-3 m-t-10">
                    <h5>Bank Name</h5>
                    <div class="controls">
