<div class="row">
    <div class="card card-outline-primary">
        ...
        <div class="card-body myModal">
            <form class="m-t-10 row" id="form_validation5" novalidate action="<?= $base_url ?>master/item/add_ajax" method="POST">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="controls">
                        <input type="text" name="data[default_weight]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
