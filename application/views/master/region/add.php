<div class="row">
    <div class="card card-outline-primary">
        ...
        <div class="card-body myModal">
            ...
            <form class="m-t-10 row" id="form_validation" novalidate action="<?= $base_url ?>master/region/add" method="POST">
                <div class="form-group col-md-12 m-t-10">
                    <h5>Region Name <span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[region_name]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
