...
+'<td><input type="text" name="vdate['+ x +'][freight_amg]" id="freight_amt_'+ row +'_'+ rc +'" class="form-control" ></td>'
+'<td><input type="text" name="vdate['+ x +'][detention_amt]" id="detention_amt_'+ row +'_'+ rc +'" class="form-control" ></td>'
+'<td><input type="text" name="vdate['+ x +'][challan_amt]" id="challan_amt_'+ row +'_'+ rc +'" class="form-control" ></td>'
...
+'<td><input type="text" name="vdate['+ x +'][desti_hire]" id="desti_hire_'+ row +'_'+ rc +'" class="form-control" ></td>'
