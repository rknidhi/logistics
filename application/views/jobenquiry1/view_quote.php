                                        ...
                                        <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($quote as $quote_row) {
                                                    ...
                                                    $rate_final_details = $this->db->where($whq)->get('tbl_vechile_rate')->row();

                                                    ?>
                                                    <tr id="row-id-<?= $quote_row->quoteid ?>">
                                                        <td><?= $sn<2?$enqno:''; ?></td>
                                                        <td><?= $sn<2?$enq_details->enq_ref_no:''; ?></td>
                                                        <td><?= $sn<2?$quote_row->quote_ref_no:''; ?></td>
                                                        <td><?= $sn<2?$enq_details->station_from:''; ?></td>
                                                        <td><?= $sn<2?$enq_details->station_to:''; ?></td>
...
<!--                                                         <td>
                                                            ...
                                                            <a class="btn1" onclick="printwindow('<?= $base_url ?>challan/printdispatch/<?= $quote_row->cdispatch_id ?>')" href="javascript:;"  href="javascript:;"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                        </td> -->
                                                    <!-- </tr> -->
                                                    <?php
                                                    $sn++;
