<div class="row">
    <div class="card card-outline-primary">
        <div class="card-header">
            <h4 class="m-b-0 text-white">Add Stationary Allotment</h4>
        </div>
        <div class="card-body">
            <form class="m-t-40 row" id="form_validation" novalidate action="<?= $base_url ?>tools/stationaryallotment/add" method="POST">
                    ...
                    <div class="controls">
                        <select name="data[st_id_fk]" id="st_id_fk" class="form-control select2">
                            ...
                            foreach ($stationaries as $stationary) {
                                echo '<option value="' . $stationary->st_id . '">' . $stationary->name . '(' . $stationary->fy_year . '-' . ($stationary->fy_year + 1) . ')' . '</option>';
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="controls">
                        <input type="text" name="data[from_no]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>

                <div class="form-group col-md-4">
                    <h5>To No.<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[to_no]" class="form-control" required data-validation-required-message="This field is required"></div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="controls">
                        <input type="text" name="data[issued_date]" id="issued_date" class="form-control singledate" required data-validation-required-message="This field is required"></div>
                </div>
