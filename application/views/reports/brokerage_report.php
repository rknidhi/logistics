...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> : Brokerage Report</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">Brokerage Report</h4>
                                </div>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            ...
                                                            <select class="form-control select2" name="broker_id_fk" required>
                                                                <option value="">Select</option>
                                    ...
                                    <div class="col-lg-12">
                                            <div class="row">
                                                <fieldset>
                                                    <legend>Total</legend>
                                                        <table width="100%">
                                                            <h4>Total brokerage Amount =  <?= number_format($grand_total,2)?>/-</h4>
                                                        </table>
                                                </fieldset>
                                            </div>
