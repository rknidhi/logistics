...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> :TDS Report</title>
                                            ...
                                            <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        ...
                                                        if ($lhc->tds > 0) {
                                                            $tds_grand_total += $lhc->tds;
                                                            $challan_grand_total += $lhc->total_freight;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= number_format($lhc->tds,2) ?></td>                                                                
                                                                <td><?= $this->function_library->FindBrokerName($lhc->broker_id_fk) ?></td>
                                    ...
                                    <div class="col-lg-12">
                                            <div class="row">
                                                <fieldset>
                                                    <legend>Total</legend>
                                                        <table width="100%">
                                                            <h4>TDS Grand Total Amount = <?= number_format($tds_grand_total,2); ?>/-</h4>
