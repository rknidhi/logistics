                                                        ...
                                                        <td width="35%">
                                                            ...
                                                            <select class="form-control select2" name="bill_to_id" required>
                                                                ...
                                                                foreach ($parties as $party) {
                                                                    echo '<option value="' . $party->party_id . '" ' . ($party->party_id == $this->input->post('bill_to_id') ? 'selected' : '') . '>' .  $party->party_name ." -($party->city)" '</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                        </td>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!-- Modified by Rakesh Dated 02-08-19 -->
                                                            <td><?= (!empty($record->payment_date)? 'Paid' :'Pending') ?></td>
                                                            <td><?= (!empty($record->payment_date)? convertToHumanDate($record->payment_date) :'') ?></td>
                                                            <!-- End -->
                                                            <!--<td><?php $this->function_library->FindPartyBranch($record->bill_to_id) ?></td>-->
                                                        </tr>
                                                        <?php
                                                        $sn++;
                                                    }
