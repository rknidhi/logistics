                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td width="23%">
                                                            <label class="control-label">DR No From</label>
                                                            <input type="text" name="dr_from" value="<?= $this->input->post('dr_from') ?>" class="form-control">
                                                        </td>
                                                        <td width="23%">
                                                            <label class="control-label">To </label>
                                                            <input type="text" name="dr_to" value="<?= $this->input->post('dr_to') ?>" class="form-control">
                                                        </td>                                                        
                                                        <td width="23%">
                                                            <label class="control-label">LHC No From</label>
                                                            <input type="text" name="lhc_from" value="<?= $this->input->post('lhc_from') ?>" class="form-control">
                                                        </td>
                                                        <td width="23%">
                                                            <label class="control-label">To</label>
                                                            <input type="text" name="lhc_to" value="<?= $this->input->post('lhc_to') ?>" class="form-control">
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                    <td width="15%">
                                                            <label class="control-label">DR Date From</label>
                                                    ...
                                                    <td width="15%">
                                                            ...
                                                            <select class="form-control select2" name="vehicle_id" style="width:100%" required>
                                                                ...
                                                                foreach ($vehicles as $vehicle) {
                                                                    echo '<option value="' . $vehicle->vehicle_id . '" ' . ($vehicle->vehicle_id == $this->input->post('vehicle_id') ? 'selected' : '') . '>' . $vehicle->registration_no . '</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                        </td>                                                        
                                                        <td width="15%">
                                                            ...
                                                            <select class="form-control select2" name="branch_id_fk" style="width:100%" required>
                                                                <option value="">Select</option>
                                                                <?php
                                            ...
                                            <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        $lhc_record = $this->functions->get_single_row('challan_dispatch', 'cdispatch_id', $record->lhc_number);
                                                        $grs = $lhc_record->gr_no_fk .','. $lhc_record->gr_no_inc;
                                                        $grs = explode(',',$grs);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $this->function_library->FindVehicle($lhc_record->vehicle_id_fk) ?></td>
                                                            <td><?= $record->from_station ?></td>
                                                            <td><?= $record->to_station ?></td>
                                                            <td><?= $this->function_library->FindBrokerName($lhc_record->broker_id_fk) ?></td>
                                                            <td><?=$record->lhc_number?></td>
                                                            <td><?=$grs?></td>
                                                            <td><?= $this->function_library->FindDriverDetails($lhc_record->driver_id_fk)->name ?></td>
                                                            <td><?= $record->remark ?></td>
