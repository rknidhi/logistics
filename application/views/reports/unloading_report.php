...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> :Unloading Report</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">Unloading Report</h4>
                                </div>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            ...
                                                            <select name="broker_id_fk" id="broker_id_fk" class="form-control select2" style="width: 100%" required>
                                                                <option value="">Select</option>
                                            ...
                                            <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                      ...
                                                      // $unloading_grand_total += $record->item_unloading_charges;
                                                         $unloading_grand_total += $lhc->unloading_ch;
                                                        
                                                        if ($lhc->unloading_ch > 0) {
                                                            ?>
                                                            <tr>
                                                                <td><?= $sn ?></td>
                                                                ...
                                                                <td><?= number_format($lhc->unloading_ch,2) ?></td>
                                    ...
                                    <div class="col-lg-12">
                                            <div class="row">
                                                <fieldset>
                                                    <legend>Total</legend>
                                                        <table width="100%">
                                                            <h4>Unloading Grand Total Amount = <?= number_format($unloading_grand_total,2); ?>/-</h4>
