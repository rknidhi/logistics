...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> :Loading Report</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">Loading Report</h4>
                                </div>
                                            ...
                                            <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        ...
                                                        //$loading_grand_total += $record->item_loading_ch;
                                                        $loading_grand_total += $lhc->loading_ch;                                                        
                                                        if ($lhc->loading_ch > 0) {
                                                            ?>
                                                            <tr>
                                                                <td><?= $sn ?></td>
                                                                ...
                                                                <td><?= number_format($lhc->loading_ch,2) ?></td>
                                    ...
                                    <div class="col-lg-12">
                                            <div class="row">
                                                <fieldset>
                                                    <legend>Total</legend>
                                                        <table width="100%">
                                                            <h4>Loading Grand Total Amount = <?= number_format($loading_grand_total,2); ?>/-</h4>
