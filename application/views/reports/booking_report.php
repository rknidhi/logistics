                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">Booking GR Reports</h4>
                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-info btn-xs" href="javascript:;" data-fancybox data-type="ajax" data-src="<?= $base_url ?>reports/booking_report/viewItems/<?= $record->bgr_id ?>">Item(s) <?= $itemCount ?></a></td>
                                                        ...
                                                        <?php
                                                        $grand_total_freight += $record->s_total_freight;
                                                        $sn++;
                                                    }
                                                    ?>
                                    ...
                                    <div class="col-lg-12">
                                            <div class="row">
                                                <fieldset>
                                                    <legend>Total</legend>
                                                        <table width="100%">
                                                            <h4>Freight Grand Total Amount = <?= number_format($grand_total_freight,2); ?>/-</h4>
                                                        </table>
                                                </fieldset>
                                            </div>
