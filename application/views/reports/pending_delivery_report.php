                                            ...
                                            <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        $grs = $record->gr_no_fk .','. $record->gr_no_inc;
                                                        $grs = explode(',',$grs);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $record->gr_fromstation ?></td>
                                                            <td><?= $record->gr_tostation ?></td>
                                                            <td><?= $this->function_library->FindBrokerName($record->broker_id_fk) ?></td>
                                                            <td><?= $this->function_library->FindDriverDetails($record->driver_id_fk)->name ?></td>
                                                            <td><?= $grs ?></td>
                                                        </tr>
                                                        <?php
                                                        $sn++;
