...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> : POD Report</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">POD Reports</h4>
                                </div>
                                            ...
                                            <legend>Filter Records</legend>
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="15%">
                                                            <label class="control-label">POD Type</label>
                                                            <select class="form-control select2" name="pod_status" required>
                                                                <option value="">Select</option>
                                                        ...
                                                        <td width="15%">
                                                            <label class="control-label">POD Received Date from</label>
                                                            <input type="text" name="pod_received_from"value="<?= $this->input->post('pod_received_from') ?>" class="form-control singledate" required>
                                                        </td>

                                                        <td width="15%">
                                                            <label class="control-label">POD Received Date To</label>
                                                            <input type="text" name="pod_received_to"value="<?= $this->input->post('pod_received_to') ?>" class="form-control singledate" required>
                                                        </td>
...
//                                                                
                                                        ...
                                                        <td>
                                                            ...
                                                            <select class="form-control select2" name="broker_id_fk" id="broker_id_fk"  required data-validation-required-message="Please select Inward">
                                                                <option value="">Select</option>
                                                                <?php
