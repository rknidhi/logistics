...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> :Pending Delivery Report</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">Pending Delivery Report</h4>
                                </div>
...
<!--                                                         <label class="control-label">Delivery Type</label>
                                                            <select name="delivery_mode_fk" id="delivery_mode_fk" class="form-control select2" style="width:100%">
                                                                ...
                                                                <?php// foreach ($delivery_modes as $delivery_mode) { ?>    
                                                                    <option value="<?php // $delivery_mode->fm_id ?>" <?= ($delivery_mode->fm_id == $this->input->post('delivery_mode_fk') ? 'selected' : '') ?>><?= $delivery_mode->freight_method ?></option>
                                                                <?php// } ?>
                                                            </select>
                                                        </td> -->
                                            ...
                                            <table id="example23" class="display table table-hover table-striped table-bordered table-responsive" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($records as $record) {
                                                        $last_location = $this->function_library->GetGRLastLocation($record->bgr_id);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <?php // $this->function_library->FindDeliveryMode($record->delivery_mode_fk) ?>
