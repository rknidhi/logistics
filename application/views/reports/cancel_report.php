...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> :Cancel Report</title>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="25%">
                                                            ...
                                                            <select name="consignor_id_fk" id="consignor_id_fk" class="form-control" style="width: 100%" required>
                                                                <option value="">Select</option>
                                                        ...
                                                        <td width="10%">
                                                            ...
                                                            <select class="form-control" name="gr_type" id="gr_type" required>
                                                                <option value="">Select</option>
                                                        ...
                                                        <td width="15%">
                                                            ...
                                                            <select class="form-control" name="broker_id_fk" id="broker_id_fk" required>
                                                                <option value="">Select</option>
                                                                <?php
