<html>
    ...
    <body onload="window.print()">
        ...
        <table id="customers" class="table-show">
            ...
            <tr>
                <td class="space" colspan="6" style="text-align: center; font-size: 20px; font-weight: bold;"> In-Ward Register </td>
            </tr>
           <tr height="20">
                <td width="15%"><strong>In-Ward</strong></td>
                <td width="20%"><?= $inward->inward_no ?></td>


                <td width="15%"><strong>Transport Name</strong></td>
                <td width="20%"><?= $inward->transport_name ?></td>
            ...
            <tr height="20">
                ...
                <td><?= $this->function_library->FindBrachAgent($inward->branch_id_fk) ?></td>
                
                <td><strong>Document Inv. No</strong></td>
                <td><?= $inward->doc_invoice_no ?></td>
            </tr>
            <tr height="20">
                <td><strong>Vendor Name</strong></td>
                <td><?= $this->function_library->FindVendor($inward->vendor_id_fk) ?></td>
                
                <td><strong>Document Date</strong> </td>
                <td><?= convertToHumanDate($inward->document_date) ?></td>
            </tr>
            <tr height="20">
