                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="m-t-10" id="form_validation" novalidate action="" method="POST">
                                                ...
                                                <form class="m-t-10" id="form_validation2" action="<?= $base_url ?>billing/creategrbill" method="POST">
                                                    <div>
                                                                    ...
                                                                    <tr id="row-id-<?= $gr_detail->bgr_id ?>">
                                                                        <td><div class="controls">
                                                                                <label class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" value="<?= $gr_detail->sgr_id ?>" name="gr_nos[]" class="custom-control-input" aria-invalid="false" required> 
                                                                                    <span class="custom-control-label" style="position:absolute"></span></label>
                                                                            </div>
                                                                        </td>
                                                                        <td><a href="<?= $base_url ?>booking/printgrgr/<?= $gr_detail->sgr_id; ?>" target="_blank"><?= $gr_detail->sgr_id; ?></a></td>
                                                                        <td><?php
                                                                        // Modified for DRS dated: 04-09-19
                                                                            echo $this->function_library->FindPartyDetails($gr_detail->party_id_fk)->party_name.'('.$this->function_library->FindPartyDetails($gr_detail->party_id_fk)->city.')';
