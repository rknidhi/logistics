                                            ...
                                            <form class="m-t-10" id="form_validation" novalidate action="" method="POST">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table width="100%">
                                                        ...
                                                        <input type="hidden" name="data[bill_to_id]" value="<?= $billing->billing_id ?>" />
                                                        <td colspan="6"><input type="text" name="data[bill_to]" readonly class="form-control" value="<?= $billing->bill_to ?>" ></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="data[invoice_date]" value="<?= convertToHumanDate($billing->invoice_date) ?>" class="form-control singledate" readonly></td>
                                                        </tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($gr_nos as $gr_no) {
                                                                ...
                                                                <td ><?= date_only_format($gr_detail->gr_date) ?></td>
                                                                    <td><input type="hidden" name="sgr_id[<?= $gr_detail->sgr_id; ?>]" value="<?= $gr_detail->sgr_id; ?>"/><?= $gr_detail->sgr_id; ?></td>
                                                                    ...
                                                                    <td><?= $this->function_library->FindFreightMethod($gr_detail->sky_freight_weight); ?></td>                                                                    
                                                                    ...
                                                                    <!-- End -->                                                          
                                                                    <td><input type="text" onkeypress="return isNumber(event)" name="settle_green_tax[<?= $gr_no ?>]" id="settle_green_tax_<?= $sn ?>" onchange="calculate(<?= $sn ?>)" value="<?= $gr_detail->settle_green_tax ?>"  class="form-control"></td>
                                                                    <td><input type="text" onkeypress="return isNumber(event)" name="settle_advance[<?= $gr_no ?>]" id="settle_advance_<?= $sn ?>" onchange="calculate(<?= $sn ?>)" value="<?= $gr_detail->settle_advance ?>"  class="form-control"></td>
