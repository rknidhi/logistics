                                                ...
                                                <a href="<?= $base_url ?>reports/bookbill_report">
                                                    <div class="homeStrip2">
                                                        ...
                                                        <div class="stripDetails">
                                                            ...
                                                            <div>
                                                                <h2><?= $total_billing_count.' / <i class="mdi mdi-currency-inr"></i>'.number_format($total_billing_amount,2) ?>
                                                                </h2>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                ...
                                                <a href="<?= $base_url ?>reports/bookbill_report">
                                                    <div class="homeStrip2">
                                                        ...
                                                        <div class="stripDetails">
                                                            ...
                                                            <div>
                                                                <h2><?= $total_received_bill .' / <i class="mdi mdi-currency-inr"></i>'.number_format($total_payment_received,2) ?>
                                                                </h2>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                ...
                                                <a href="<?= $base_url ?>reports/bookbill_report">
                                                    <div class="homeStrip2">
                                                        ...
                                                        <div class="stripDetails">
                                                            ...
                                                            <div>
                                                                <h2><?= ($total_billing_count - $total_received_bill) .' / <i class="mdi mdi-currency-inr"></i>'.number_format(($total_billing_amount - $total_payment_received),2) ?>
                                                                </h2>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
