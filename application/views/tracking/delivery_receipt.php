...
<head>
    ...
    <title><?php echo $this->config->item('title_prefix'); ?> : Create Delivery Receipt</title>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-primary">
                            <div class="card-header ">
                                <h4 class="m-b-0 text-white">LHC</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="form-group col-md-12 text-center">
                                            <div class="col-sm-12">
                                                <button type="submit" class="btn btn-success btn1" name="submit"
                                                    ...
                                                    <a href="<?= $base_url ?>delivery_receipt"class="btn btn-warning btn1"><i class="fa  fa-plus"></i> New</a>
