...
<html lang="en">
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> : View LHC</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    ...
                                    <div class="card-icon">
                                        <button type="button" class="btn btn-warning btn2"><i class="fa fa-plus addIcon"></i> Create Loading Slip</button>    
                                    </div>
                                    </a>
                                    <h4 class="card-title">View Loading Slip</h4>
                                </div>
                                <div class="card-body">
...
<!--                                                         <td><?php //= $challan_dispatch->gr_no_fk ?></td> -->
                                                        <td><?= $challan_dispatch->lhc_number ?></td>
                                                        <td><?= convertToHumanDate($challan_dispatch->added_on) ?></td>
                                                        <td><?= $challan_dispatch->gr_fromstation ?></td>
                                                        <td><?= $challan_dispatch->gr_tostation ?></td>
                                                        <td><?= $challan_dispatch->gr_vehicle_no ?></td>
                                                        <td><?= $this->function_library->FindBrokerDetails($challan_dispatch->broker_id_fk)->broker ?></td>
                                                        <td><?= number_format($challan_dispatch->total_freight,2) ?></td>
