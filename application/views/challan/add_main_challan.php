<div class="row">
    <div class="card card-outline-primary">
        <div class="card-header">
            <h4 class="m-b-0 text-white">Add Main Challan</h4>
        </div>
        <div class="card-body">
            <form class="m-t-40 row" id="form_validation" novalidate action="<?= $base_url ?>challan/add_new_main_challan" method="POST">
                <input type="hidden" name="data[bgr_id_fk]" value="<?= $bgr_id_fk ?>"/>
                <div class="form-group col-md-4">
                    <h5>Challan Date<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="data[challan_date]" class="form-control singledate" required ></div>
                </div>

                <div class="form-group col-md-4">
                    <h5>Challan Number</h5>
                    <div class="controls">
                        <input type="text" name="data[challan_number]" class="form-control" required></div>
                </div>

                <div class="form-group col-md-4">
                    <h5>Challan Amount</h5>
                    <div class="controls">
                        <input type="text" name="data[challan_amount]" onkeypress="return isNumber(event)" class="form-control"></div>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="controls">
                        <input type="text" name="data[challan_location]" class="form-control"></div>
                </div>
                    ...
                    success: function (data)
                    {
                        ...
                        if (response.status == 'success') {
                            ...
                            if (response.button_val == 'print') {
                                printwindow('<?= $base_url ?>challan/printmainchallan/' + response.main_challan_id);
                            }
                        } else {
