                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="gr_no"
                                                                    ...
                                                                    style="font-weight:bold;" class="form-control" value="<?php echo next_id('settlement_gr');?>" readonly></td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="text" name="data[sky_freight]"
                                                                onkeypress="return isNumber(event)"
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" name="data[sky_driver_adv]"
                                                                onkeypress="return isNumber(event)"
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" name="data[sky_vendor_vechile_freight]"
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" name="data[sky_vendor_vechile_adv]"
                                                                onkeypress="return isNumber(event)"
                                                        ...
                                                        <td width="20%">
                                                            ...
                                                            <input type="text" name="data[remarks]"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="16%">
                                                            ...
                                                            <input type="text" name="data[sky_freight_weight]"
                                                                id="sky_freight_weight" class="form-control">
<!--                                                             <select class="form-control select2"
                                                                name="data_gr[sky_freight_weight]"
                                                                id="sky_freight_weight" class=""
                                                                >
                                                                <option value="">Select</option>
                                                                <?php
                                                                //foreach ($freight_methods as $freight) {
                                                                    //echo '<option value="' . $freight->fm_id . '">' . $freight->freight_method . '</option>';
                                                                //}
                                                                ?>
                                                            </select> -->
                                                        </td>                                             
