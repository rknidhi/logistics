...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> : Voucher</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    ...
                                    <div class="card-icon">
                                        <button type="button" class="btn btn-warning btn2"><i class="fa fa-plus addIcon"></i> <a href="<?= $base_url ?>accounts/voucher">Create Voucher</a></button>    
                                    </div>
                                ...
                                <div class="card-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="date_from" value="<?= $this->input->post('date_from')?>" class="form-control singledate"></td>
                                                        <td><label>To</label></td>
                                                        <td><input type="text" name="date_to" value="<?= $this->input->post('date_to')?>" class="form-control singledate"></td>
                                                        ...
                                                        <td width="100"><label>Voucher No.</label></td>
                                                        <td width="150">
                                                            <input type="text" name="voucher_id" id="voucher_id" value="<?= @$post_data['voucher_id'] ?>" class="form-control" required>
                                                        </td>
                                        ...
                                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered table-responsive" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Amount</th>
                                                    <th>Branch</th>
                                                    <th>Payment For</th> <!-- Edited by Rakesh-->
                                                    <th>Particulars</th>
                                                    <th>Action</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($vouchers as $voucher) {
                                                    ...
                                                    <tr id="row-id-<?= $voucher->voucher_id ?>">
                                                        ...
                                                        <td><?= $this->function_library->FindLedgerName($voucher->ledger) ?></td>
                                                        
                                                        <td><?= number_format($voucher->amount,2) ?></td>
                                                        <td><?= $this->function_library->FindBrachAgent($voucher->branch_id_fk) ?></td>
                                                        <td><?php if(!empty($voucher->gr_no_disp)){  echo $voucher->gr_no_disp; }?></td> <!-- Edited by Rakesh-->
                                                        ...
                                                        ?>                                                            
                                                            ...
                                                            <a class="trash trash-me material-icons" id="<?= $voucher->voucher_no.'|'.$voucher->voucher_type.'|'.$voucher->branch_id_fk; ?>"><i class="fa fa-trash"></i></a>
                                                            <a class="edit" href="<?= $base_url ?>accounts/voucher/editvoucher/<?= $voucher->voucher_id ?>" href="javascript:;"><i class="fa fa-pencil-alt"></i></a>
                                                            <!--<a class="edit" href="<?= $base_url ?>accounts/voucher/edit_voucher/<?//= $voucher->voucher_id ?>"><i class="fa fa-pencil-alt"></i></a>-->
                                                            <a class="btn" onclick="printwindow('<?= $base_url ?>accounts/voucher/printvoucher/<?= $voucher->voucher_id ?>')" href="javascript:;"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                        <?php
                                                          $view_edit= FALSE;
                                                         }
                                                        else {
                                    ...
                                    if (!empty($gr_details->bgr_id)) {
                                        ...
                                        <div class="form-group col-md-12 text-center">
                                            <div class="col-sm-12">
                                                <a data-fancybox data-type="ajax" data-src="<?= $base_url ?>accounts/voucher/add_voucher/<?= $gr_details->bgr_id ?>" href="javascript:;" class="btn btn-warning btn1"><i class="fa fa-plus"></i> New</a>
                                                <a href="<?= $base_url ?>accounts/voucher" class="btn btn-info btn1"><i class="fa  fa-times"></i> Close</a>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
