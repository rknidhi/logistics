<div class="row">
        <div class="card card-outline-primary">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Add Bill Amount</h4>
            </div>
...
$('select').on('change', function(){
    ...
    $.ajax({
            ...
            success: function(response) {
                ...
                $('tr#'+rowno).find('td:eq(5)').html(record.billamount-record.received_amount);                
                gettotal();
            }
        });
});
