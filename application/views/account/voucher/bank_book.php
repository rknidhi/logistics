...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> : Bank Book</title>
                                    ...
                                    <form id="form_validation" novalidate action="" method="POST">
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td width="5%"><label class="control-label">Company</label></td>
                                                        <td width="20%">
                                                        ...
                                                        <td width="5%"><label class="control-label ">Branch</label></td>
                                                        <td width="20%">
                                                        ...
                                                        <td width="5%"><label class="control-label">User Type</label></td>
                                                        <td width="10%">
                                                            <div class="form-group">
                                                                <select name="ltype_id_fk" id="ltype_id_fk" class="form-control" required>
                                                                    <option value="">--Select--</option>
                                                                    <?php
                                                                    foreach ($this->functions->get_all_active_row('tbl_ledger_type') as $ledger_type) {
                                                                        echo '<option value="' . $ledger_type->ltype_id . '"  ' . ($ledger_type->ltype_id == $this->input->post('ltype_id_fk') ? 'selected' : '') . '>' . $ledger_type->ledger_type . '</option>';
                                                                    }
                                                                    ?>
                                                        ...
                                                        <td width="5%"><label class="control-label ">Ledger</label></td>
                                                        <td width="30%">
