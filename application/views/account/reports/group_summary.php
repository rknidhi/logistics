...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->config->item('title_prefix'); ?> : Group Summary</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    <h4 class="card-title">Group Summary</h4>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select class="form-control select2" name="group_name">
                                                                ...
                                                                echo fetchgroup_select($this->functions->get_all_row1('ac_account_group'),'0','',$this->input->post('group_name'));
                                                                /*  foreach ($ac_groups as $ac_group) {
                                                                        echo '<option value="' . $ac_group->aag_id . '" ' . ($ac_group->aag_id == $this->input->post('group_name') ? 'selected' : '') . '>' . $ac_group->group_name . '</option>';
                                                                    } */
                                                                // End
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($vouchers as $voucher) {
                                                        ...
                                                        <tr id="row-id-<?= $voucher->voucher_id ?>">
                                                            ...
                                                            <td><?= $opening_balance = $this->function_library->GetOpeningBalance($voucher->ledger) ?></td>
                                                            <td><?= $voucher->voucher_type ?></td>
                                                            <td><?= $voucher->voucher_no ?></td>
                                                            <td><?= $this->config->item('trans_type')[$voucher->transaction_type] ?></td>
                                                            <td><?= $voucher->amount ?></td>
                                                            <td><?= $voucher->narration ?></td>
                                                            <td><?= $this->function_library->GetClosingBalance($opening_balance, $voucher->transaction_type, $voucher->amount) ?></td>
                                                        </tr>
                                                        <?php
                                                        $sn++;
                                                    }
