                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($vouchers as $voucher) {
                                                        ...
                                                        <tr id="row-id-<?= $voucher->voucher_id ?>">
                                                            ...
                                                            <td><?= $latest_opening_balance ?></td>
                                                            <td><?= $voucher->voucher_type ?> <!--| <?//= $voucher->transaction_type; ?>--></td>
                                                            <td><?= $voucher->voucher_no ?></td>
                                                            <td><?= $this->config->item('trans_type')[$voucher->transaction_type] ?></td>
                                                            <td><?= number_format($voucher->amount,2) ?></td>

                                                            <td><?= $voucher->narration ?></td>
                                                            <td><?= number_format($this->function_library->GetClosingBalance($latest_opening_balance, $voucher->transaction_type, $voucher->amount),2) ?></td>
                                                        </tr>
                                                        <?php
                                                        $sn++;
                                                    }
