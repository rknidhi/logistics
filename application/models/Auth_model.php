...
class Auth_model extends CI_Model {
    ...
    function update_account() {
        ...
        $validation_rules = array(
            array('field' => 'update_user_firstname', 'label' => 'First Name', 'rules' => 'required'),
            array('field' => 'update_user_lastname', 'label' => 'Last Name', 'rules' => 'required'),
        ...
        if ($this->form_validation->run()) {
            ...
            $profile_data = array(
                ...
                'user_firstname' => $this->input->post('update_user_firstname'),
                'user_lastname' => $this->input->post('update_user_lastname'),
                'user_phone' => $this->input->post('update_phone_number'),
    ...
    public function reset_password() {
        $user_id = $this->input->post('upro_id');
        $identity = $this->input->post('user_email_id');
        $new_password = $this->input->post('new_password');
        $this->flexi_auth->change_password_by_admin($user_id, $identity, $new_password);
        return TRUE;
    }
